...
#Константы - значение атаки, защит, выносливости по умолчанию
DEFAULT_ATTACK = 5
DEFAULT_DEFENCE = 10
DEFAULT_STAMINA = 80
...
class Character:
    ...
    BRIEF_DESC_CHAR_CLASS = 'BRIEF_DESC_CHAR_CLASS'
    SPECIAL_BUFF = 15
    SPECIAL_SKILL = 'Удача'
...
def start_training(character):
    ...
    while cmd != 'skip':
        ...
        if cmd not in commands:
            ...
            char_action: Character = char_classes[cmd](char_name)
            print(char_action(char_name, char_class))
